...
public class TestGridSupplier 
{
	...
	//
	// The following was composed in 2012 by mathematician Arto Inkala, who claims it is
	// "the world's hardest Sudoku". The British newspaper The Telegraph, which rates
	// Sudokus from 1 star (easiest) to 5 stars (hardest) gave this one 11 stars.
	//
	// How long does it take your app to solve the world's hardest Sudoku? Warning: this
	// one needs a lot of backtracking, so remove all println statements from your code
	// before trying it. Post your time to Piazza for participation points.
	//
	private final static String[] 		INKALA =
	{
		"8........",
		"..36.....",
		".7..9.2..",
	...
	static Grid getInkala()			{ return new Grid(INKALA); }
